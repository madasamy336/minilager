        ...
        <div className="ui form w-50 w-sm-100">
            ...
            <label className='fw-500 fs-7 mb-2'>{t(props.placeholder)} <i className="text-danger ">*</i></label>
                ...
                {!toggle && <div onClick={showPasswordHandler}>
                    <svg className="eyeopen position-absolute r-2 t-4" xmlns="http://www.w3.org/2000/svg" width="15" height="40" viewBox="0 0 31.937 21.446">
                ...
                {toggle && <div onClick={showPasswordHandler}>
                    <svg className="eyeclose position-absolute r-2 t-4" xmlns="http://www.w3.org/2000/svg" width="15" height="40" viewBox="0 0 31.937 25.414">
