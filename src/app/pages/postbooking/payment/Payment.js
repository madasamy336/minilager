...
export default function Payment() {
  ...
  return (
    <div className="mx-2 mx-sm-1">
      <p className="my-1 p-1 text-right"><span className="p-1 payment-alert-msg d-inline-flex align-items-center"><svg className="mr-1" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 19.324 19.328">
      ...
      <div className="bg-white card-boxShadow border-radius-15 pb-2 mb-2">
