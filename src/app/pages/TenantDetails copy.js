  ...
  return (
    <>
      ...
      <div className="ui container bg-white card-boxshadow border-radius-15 py-2">
        ...
        </svg><span className='veritical-align-text-top ml-1'>Tenant Details</span></h6>
        ...
        <div className="col-12 px-sm-2" id="EmergencyContactDiv">
          {
            contactaccordian.map((data, index) => (
              <TenantDetailEmergengyContactAccordian removefunction={removeEmergencyContact} key={index} index={index} contactLength={data.contactaccordianLength} firtName={data.firname} lastName={data.lastname} email={data.email} phone={data.phone} />
            ))
          }
        </div>
