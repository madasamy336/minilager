    ...
    <>
      ...
      <div className="esign">
        <div className="ui container">
          <div className="bg-white card-boxShadow px-2 py-3 border-radius-10 mb-4">
            <div className="row">
              <div className="col-lg-3 col-md-3 col-12 px-1">
                <div className="card-img h-100">
                  <img className="w-100 h-75 border-radius-10" src="/assets/images/Minilager-Container.png" alt="Container" />
                </div>
              </div>
              <div className="col-lg-5 col-md-5 col-12 px-1">
                <div className="card-desc card-bg-secondary p-2 border-radius-10">
                  <h2 className="fs-4 fw-700 mb-2">#18B</h2>
                  <div className="pb-1"><span>Unit - <strong className="fw-700">5 X 10</strong> (large)</span></div>
                  <div><span>Warehouse, Crestline</span></div>
          ...
          <div className='row'>
            <div className='col-12 col-md-7 pr-1 pr-sm-0 mb-3'>
                ...
                <div className='p-3'>
                    <div className='card-bg-secondary w-100 px-2 py-2'>
                      ...
                      <div class="text-center mt-4">
                        <button class="ui button bg-white text-success-dark border-success-dark-1 fs-7 fw-400 text-dark px-5 mr-2">Preview</button>
                        <button class="ui button bg-white text-success-dark border-success-dark-1 fs-7 fw-400 text-dark px-5 mr-2">Download</button>
                      </div>
                    </div>
                  <div className='row mt-2'>
                    <div className='col-lg-6'>
                        <div className='card-border border-radius-5 mr-2'>
                    ...
                    <div className='col-lg-6'>
                        <div className='card-border border-radius-5 ml-2'>
                          <h6 className='card-bg-secondary p-2 text-success-dark fs-6'>INITIATOR</h6>
                          <div className='py-2 px-1'>
                            <p className='fw-600 fs-6 mb-1'>Fountainlakestorage</p>
                            <p>Non Signatory Party</p>
              ...
              <div class="text-center mt-4">
                <button class="ui button bg-white text-success-dark border-success-dark-1 fs-7 fw-400 text-dark px-5 mr-2">BACK</button>
              </div>
            </div>
