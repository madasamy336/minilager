...
export default function AddOn() {
  ...
  const serviceSelected = (e,serviceid)=>{
    if(e.target.checked === true){
      
    }
    servicesArray.indexOf(serviceid) === -1 ? servicesArray.push(serviceid) : '';
  }
    ...
    instance
      ...
      .then(response => {
        if (response.data.result !== null && response.data.result !== 'undefined') {
          ...
          setinsuranceResponse(response.data.result[0].addOns.insurance);
                  ...
                  {typeof addOnsResponse !== 'undefined' && addOnsResponse !== null && addOnsResponse.services !== 'undefined' && addOnsResponse.services !== null ?
                    addOnsResponse.services.map((item) => {
                      ...
                      if(item.isMandatory == true){
                        servicesArray.indexOf(item.id) === -1 ? servicesArray.push({serviceid:item.id}) : '';
                      }
                            ...
                            <div className='col-lg-8 col-md-8 col-sm-8'>
                              <div className='d-flex align-items-center'>
                                {item.isMandatory == true ?
                                  ...
                                  <input type="checkbox" value={item.id} onChange={(e)=>{serviceSelected(e,item.id)}}/>
