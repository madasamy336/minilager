            ...
            <div className="ui container fluid">
                ...
                <div>
                    ...
                    <div className="ui action left icon input bg-white align-items-center position-relative">
                        ...
                        <input className='border-0 border-radius-0' placeholder="Zip, City or Address" type="text" /><i aria-hidden="true" className="search icon"></i><button className="ui button btn-success">Search</button>
                        </div>
                        <Card />
                    </div>
                </div>
